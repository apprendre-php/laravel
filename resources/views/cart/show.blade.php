...
@section('content')
    <h2 class="text-blue-800 text-2xl mb-4">Mon Panier</h2>
    @if($order)
        ...
        <div class="mb-4 w-1/3">
            <a href="{{ route('orders.cancel', $order) }}" class="text-center text-white uppercase bg-red-500 font-bold py-3 hover:bg-red-300">Annuler la commande</a>
        </div>
